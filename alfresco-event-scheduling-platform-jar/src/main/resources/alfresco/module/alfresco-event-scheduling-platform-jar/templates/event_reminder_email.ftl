                                    ...
                                    <tr>
                                       <td>
                                          ...
                                          <div style="font-size: 14px; margin: 12px 0px 24px 0px; padding-top: 10px; border-top: 1px solid #aaaaaa;">
                                             ...
                                             <p>Don't forget to give your availabilities for the event "${document.properties["cm:title"]!""}" created by <a href="${shareUrl}/page/user/${creator}/profile">${eventSchedulingUtils.getPersonFullName(creator)?trim}</a><#if document.properties["evtsched:place"]?? && document.properties["evtsched:place"]?has_content> that taking place in "${document.properties["evtsched:place"]!""}"</#if>.</p>
