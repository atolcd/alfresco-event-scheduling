                                    ...
                                    <tr>
                                       <td>
                                          ...
                                          <div style="font-size: 14px; margin: 12px 0px 24px 0px; padding-top: 10px; border-top: 1px solid #aaaaaa;">
                                             ...
                                             <p><a href="${shareUrl}/page/user/${creator}/profile">${eventSchedulingUtils.getPersonFullName(creator)?trim}</a> a créé un nouvel événement "${document.properties["cm:title"]!""}"<#if document.properties["evtsched:place"]?? && document.properties["evtsched:place"]?has_content> qui aura lieu à "${document.properties["evtsched:place"]!""}"</#if>.</p>
