                                    ...
                                    <tr>
                                       <td>
                                          ...
                                          <div style="font-size: 14px; margin: 12px 0px 24px 0px; padding-top: 10px; border-top: 1px solid #aaaaaa;">
                                             ...
                                             <p>Vergessen Sie nicht Ihre Verfügbarkeiten für den Termin "${document.properties["cm:title"]!""}" (erstellt von <a href="${shareUrl}/page/user/${creator}/profile">${eventSchedulingUtils.getPersonFullName(creator)?trim}</a>)<#if document.properties["evtsched:place"]?? && document.properties["evtsched:place"]?has_content>, Ort: "${document.properties["evtsched:place"]!""}"</#if> bekanntzugeben.</p>
                                             <#if document.properties["cm:description"]??>
                                             <p>${document.properties["cm:description"]!""}<p>
                                             </#if>

                                             Sie können Ihre Verfügbarkeit direkt auf <a href="${shareUrl}/page/answer-event?nodeRef=${document.nodeRef}">dieser Seite</a> oder auf <a href="${shareUrl}/page/user/${recipient}/dashboard">Ihrem Dashboard</a>&nbsp;*<#if siteId?has_content> oder auf dem<a href="${shareUrl}/page/site/${siteId}/dashboard">Seiten-Dashboard</a></#if> bekanntgeben.
